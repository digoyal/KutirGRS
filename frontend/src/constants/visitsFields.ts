...
export const VISITS_FIELDS: FieldMeta[] = [
  ...
  { key: "physical_vs_registered",      label: "Physical vs Registered", hideable: true,  defaultVisible: false },
  { key: "follow_timetable",            label: "Follows Timetable",      hideable: true,  defaultVisible: false },
  { key: "follow_monthly_plan",         label: "Follows Monthly Plan",   hideable: true,  defaultVisible: false },
  { key: "timeslot_utilization",        label: "Timeslots",              hideable: true,  defaultVisible: true  },
